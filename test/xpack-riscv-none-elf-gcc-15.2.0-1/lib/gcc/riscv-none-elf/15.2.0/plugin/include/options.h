...
enum opt_code
{
  ...
  OPT__param_vect_force_slp_ = 360,          /* --param=vect-force-slp= */
  OPT__param_vect_induction_float_ = 361,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 362,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 363,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 364,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 365,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 366,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 367,/* --param=vect-partial-vector-usage= */
  ...
  OPT__param_vsetvl_strategy_ = 372,         /* --param=vsetvl-strategy= */
  /* OPT__pass_exit_codes = 373, */          /* --pass-exit-codes */
  /* OPT__pedantic = 374, */                 /* --pedantic */
  /* OPT__pedantic_errors = 375, */          /* --pedantic-errors */
  /* OPT__pie = 376, */                      /* --pie */
  /* OPT__pipe = 377, */                     /* --pipe */
  /* OPT__prefix = 378, */                   /* --prefix */
  /* OPT__prefix_ = 379, */                  /* --prefix= */
  /* OPT__preprocess = 380, */               /* --preprocess */
  /* OPT__print_file_name = 381, */          /* --print-file-name */
  /* OPT__print_file_name_ = 382, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 383, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 384, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 385, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 386, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 387, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 388, */          /* --print-multiarch */
  /* OPT__print_prog_name = 389, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 390, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 391, */        /* --print-search-dirs */
  /* OPT__print_supported_extensions = 392, *//* --print-supported-extensions */
  ...
  OPT_Wa_ = 464,                             /* -Wa, */
  OPT_Wabi = 465,                            /* -Wabi */
  OPT_Wabi_tag = 466,                        /* -Wabi-tag */
  OPT_Wabi_ = 467,                           /* -Wabi= */
  OPT_Wabsolute_value = 468,                 /* -Wabsolute-value */
  OPT_Waddress = 469,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 470,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 471,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 472,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 473,                       /* -Waliasing */
  OPT_Walign_commons = 474,                  /* -Walign-commons */
  /* OPT_Waligned_new = 475, */              /* -Waligned-new */
  OPT_Waligned_new_ = 476,                   /* -Waligned-new= */
  OPT_Wall = 477,                            /* -Wall */
  OPT_Walloc_size = 478,                     /* -Walloc-size */
  OPT_Walloc_size_larger_than_ = 479,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 480,                     /* -Walloc-zero */
  OPT_Walloca = 481,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 482,            /* -Walloca-larger-than= */
  OPT_Wampersand = 483,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 484,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 485,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_double_fclose = 486,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 487,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 488,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 489,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 490,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 491,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 492,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 493,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 494,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 495,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 496,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 497,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 498,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 499,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_loop = 500,         /* -Wanalyzer-infinite-loop */
  OPT_Wanalyzer_infinite_recursion = 501,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 502,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 503,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 504,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 505,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 506,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 507,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_overlapping_buffers = 508,   /* -Wanalyzer-overlapping-buffers */
  OPT_Wanalyzer_possible_null_argument = 509,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 510,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 511,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 512,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 513,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 514,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_symbol_too_complex = 515,    /* -Wanalyzer-symbol-too-complex */
  OPT_Wanalyzer_tainted_allocation_size = 516,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 517,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 518,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 519,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 520,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 521,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 522,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_undefined_behavior_ptrdiff = 523,/* -Wanalyzer-undefined-behavior-ptrdiff */
  OPT_Wanalyzer_undefined_behavior_strtok = 524,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 525,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 526,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 527,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 528,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 529,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 530,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 531,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 532,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 533,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 534,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 535,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 536,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 537, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 538,                  /* -Warray-bounds= */
  OPT_Warray_compare = 539,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 540, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 541,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 542,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 543,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 544, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 545,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 546,              /* -Wattribute-warning */
  OPT_Wattributes = 547,                     /* -Wattributes */
  OPT_Wattributes_ = 548,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 549,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 550, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 551,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 552,                   /* -Wbool-compare */
  OPT_Wbool_operation = 553,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 554,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 555,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 556,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 557, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 558,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 559,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 560,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 561,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 562,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 563,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 564, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 565,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 566,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 567,               /* -Wc++23-extensions */
  OPT_Wc__26_extensions = 568,               /* -Wc++26-extensions */
  /* OPT_Wc__2a_compat = 569, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 570,                 /* -Wc-binding-type */
  OPT_Wc11_c23_compat = 571,                 /* -Wc11-c23-compat */
  /* OPT_Wc11_c2x_compat = 572, */           /* -Wc11-c2x-compat */
  OPT_Wc23_c2y_compat = 573,                 /* -Wc23-c2y-compat */
  OPT_Wc90_c99_compat = 574,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 575,                 /* -Wc99-c11-compat */
  OPT_Wcalloc_transposed_args = 576,         /* -Wcalloc-transposed-args */
  OPT_Wcannot_profile = 577,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 578,                      /* -Wcase-enum */
  OPT_Wcast_align = 579,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 580,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 581,             /* -Wcast-function-type */
  OPT_Wcast_qual = 582,                      /* -Wcast-qual */
  OPT_Wcast_result = 583,                    /* -Wcast-result */
  OPT_Wcast_user_defined = 584,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 585, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 586,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 587,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 588,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 589,           /* -Wcharacter-truncation */
  OPT_Wchkp = 590,                           /* -Wchkp */
  OPT_Wclass_conversion = 591,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 592,                /* -Wclass-memaccess */
  OPT_Wclobbered = 593,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 594,                /* -Wcomma-subscript */
  OPT_Wcomment = 595,                        /* -Wcomment */
  /* OPT_Wcomments = 596, */                 /* -Wcomments */
  OPT_Wcompare_distinct_pointer_types = 597, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 598,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 599,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 600,        /* -Wconditionally-supported */
  OPT_Wconversion = 601,                     /* -Wconversion */
  OPT_Wconversion_extra = 602,               /* -Wconversion-extra */
  OPT_Wconversion_null = 603,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 604,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 605,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 606,   /* -Wcoverage-too-many-conditions */
  OPT_Wcoverage_too_many_paths = 607,        /* -Wcoverage-too-many-paths */
  OPT_Wcpp = 608,                            /* -Wcpp */
  ...
  OPT_Wexternal_argument_mismatch = 652,     /* -Wexternal-argument-mismatch */
  OPT_Wextra = 653,                          /* -Wextra */
  OPT_Wextra_semi = 654,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 655,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 656,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 657,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 658,                    /* -Wfloat-equal */
  /* OPT_Wformat = 659, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 660,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 661,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 662,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 663,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 664, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 665,               /* -Wformat-overflow= */
  OPT_Wformat_security = 666,                /* -Wformat-security */
  OPT_Wformat_signedness = 667,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 668, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 669,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 670,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 671,             /* -Wformat-zero-length */
  OPT_Wformat_ = 672,                        /* -Wformat= */
  OPT_Wframe_address = 673,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 674,             /* -Wframe-larger-than= */
  OPT_Wfree_labels = 675,                    /* -Wfree-labels */
  OPT_Wfree_nonheap_object = 676,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 677,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 678,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 679,                  /* -Wglobal-module */
  OPT_Whardened = 680,                       /* -Whardened */
  OPT_Wheader_guard = 681,                   /* -Wheader-guard */
  /* OPT_Whsa = 682, */                      /* -Whsa */
  OPT_Wif_not_aligned = 683,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 684,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 685,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 686,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 687, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 688,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 689,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 690,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 691,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 692,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 693, */                   /* -Wimport */
  OPT_Winaccessible_base = 694,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 695,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 696,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 697,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 698,             /* -Winit-list-lifetime */
  OPT_Winit_self = 699,                      /* -Winit-self */
  OPT_Winline = 700,                         /* -Winline */
  OPT_Wint_conversion = 701,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 702,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 703,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 704,               /* -Winteger-division */
  OPT_Winterference_size = 705,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 706,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 707,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 708,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 709,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 710,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 711,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 712,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 713,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 714,               /* -Wjump-misses-init */
  OPT_Wl_ = 715,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 716, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 717,                   /* -Wlarger-than= */
  OPT_Wleading_whitespace_ = 718,            /* -Wleading-whitespace= */
  OPT_Wline_truncation = 719,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 720,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 721,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 722,                     /* -Wlogical-op */
  OPT_Wlong_long = 723,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 724,              /* -Wlto-type-mismatch */
  OPT_Wmain = 725,                           /* -Wmain */
  OPT_Wmaybe_musttail_local_addr = 726,      /* -Wmaybe-musttail-local-addr */
  OPT_Wmaybe_uninitialized = 727,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 728,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 729,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 730,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 731,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 732,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 733,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 734,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 735,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 736,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 737,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 738,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 739, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 740,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 741, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_name = 742,         /* -Wmissing-parameter-name */
  OPT_Wmissing_parameter_type = 743,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 744,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 745,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 746,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 747,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 748,  /* -Wmissing-variable-declarations */
  OPT_Wmudflap = 749,                        /* -Wmudflap */
  OPT_Wmultichar = 750,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 751,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 752,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 753,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 754,                     /* -Wnamespaces */
  OPT_Wnarrowing = 755,                      /* -Wnarrowing */
  OPT_Wnested_externs = 756,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 757, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 758, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 759, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 760, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 761, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 762, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 763,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 764,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 765,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 766,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 767,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 768,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 769, */               /* -Wnormalized */
  OPT_Wnormalized_ = 770,                    /* -Wnormalized= */
  OPT_Wnrvo = 771,                           /* -Wnrvo */
  OPT_Wnull_dereference = 772,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 773,                /* -Wobjc-root-class */
  OPT_Wodr = 774,                            /* -Wodr */
  OPT_Wold_style_cast = 775,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 776,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 777,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 778,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 779,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 780,                    /* -Wopenmp-simd */
  OPT_Woverflow = 781,                       /* -Woverflow */
  OPT_Woverlength_strings = 782,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 783, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 784,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 785,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 786,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 787,            /* -Woverwrite-recursive */
  OPT_Wp_ = 788,                             /* -Wp, */
  OPT_Wpacked = 789,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 790,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 791,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 792,                         /* -Wpadded */
  OPT_Wparentheses = 793,                    /* -Wparentheses */
  OPT_Wpedantic = 794,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 795,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 796,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 797,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 798, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 799,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 800,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 801,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 802,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 803,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 804,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 805,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 806,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 807,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 808,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 809,                       /* -Wprotocol */
  OPT_Wpsabi = 810,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 811,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 812,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 813,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 814,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 815,                /* -Wredundant-decls */
  OPT_Wredundant_move = 816,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 817,                 /* -Wredundant-tags */
  OPT_Wregister = 818,                       /* -Wregister */
  OPT_Wreorder = 819,                        /* -Wreorder */
  OPT_Wrestrict = 820,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 821,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 822,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 823,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 824,           /* -Wscalar-storage-order */
  OPT_Wselector = 825,                       /* -Wselector */
  OPT_Wself_move = 826,                      /* -Wself-move */
  OPT_Wsequence_point = 827,                 /* -Wsequence-point */
  OPT_Wshadow = 828,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 829, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 830,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 831, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 832,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 833, */            /* -Wshadow=global */
  OPT_Wshadow_local = 834,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 835,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 836,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 837,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 838, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 839,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 840,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 841,                /* -Wsign-conversion */
  OPT_Wsign_promo = 842,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 843,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 844,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 845,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 846,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 847,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 848,                    /* -Wspeculative */
  OPT_Wstack_protector = 849,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 850,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 851,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 852,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 853,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 854,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 855,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 856,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 857,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 858,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 859,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 860, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 861,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 862,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 863,            /* -Wstringop-truncation */
  OPT_Wstyle = 864,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 865,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 866,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 867,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 868,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 869,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 870,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 871,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 872,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 873,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 874,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 875,               /* -Wsuggest-override */
  OPT_Wsurprising = 876,                     /* -Wsurprising */
  OPT_Wswitch = 877,                         /* -Wswitch */
  OPT_Wswitch_bool = 878,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 879,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 880,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 881,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 882,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 883,                      /* -Wsync-nand */
  OPT_Wsynth = 884,                          /* -Wsynth */
  OPT_Wsystem_headers = 885,                 /* -Wsystem-headers */
  OPT_Wtabs = 886,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 887,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 888,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 889,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 890,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 891,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 892,                      /* -Wtemplates */
  OPT_Wterminate = 893,                      /* -Wterminate */
  OPT_Wtraditional = 894,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 895,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 896, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 897,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 898,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 899,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 900,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 901,                           /* -Wtsan */
  OPT_Wtype_limits = 902,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 903,            /* -Wundeclared-selector */
  OPT_Wundef = 904,                          /* -Wundef */
  OPT_Wundefined_do_loop = 905,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 906,                      /* -Wunderflow */
  OPT_Wunicode = 907,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 908,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 909,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 910,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 911,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 912, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 913, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 914,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 915,/* -Wunterminated-string-initialization */
  OPT_Wunused = 916,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 917,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 918,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 919, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 920,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 921,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 922,                /* -Wunused-function */
  OPT_Wunused_label = 923,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 924,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 925,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 926,               /* -Wunused-parameter */
  OPT_Wunused_result = 927,                  /* -Wunused-result */
  OPT_Wunused_value = 928,                   /* -Wunused-value */
  OPT_Wunused_variable = 929,                /* -Wunused-variable */
  OPT_Wuse_after_free = 930,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 931,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 932,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 933,                   /* -Wuseless-cast */
  OPT_Wvarargs = 934,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 935,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 936,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 937,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 938,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 939,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 940,            /* -Wvirtual-move-assign */
  OPT_Wvla = 941,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 942,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 943,                  /* -Wvla-parameter */
  OPT_Wvolatile = 944,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 945,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 946,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 947,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 948,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 949,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 950,                       /* -Wzerotrip */
  OPT_X = 951,                               /* -X */
  OPT_Xassembler = 952,                      /* -Xassembler */
  OPT_Xf = 953,                              /* -Xf */
  OPT_Xlinker = 954,                         /* -Xlinker */
  OPT_Xpreprocessor = 955,                   /* -Xpreprocessor */
  OPT_Z = 956,                               /* -Z */
  OPT_ansi = 957,                            /* -ansi */
  OPT_aux_info = 958,                        /* -aux-info */
  /* OPT_aux_info_ = 959, */                 /* -aux-info= */
  OPT_c = 960,                               /* -c */
  OPT_callgraph = 961,                       /* -callgraph */
  OPT_copyext = 962,                         /* -copyext */
  OPT_coverage = 963,                        /* -coverage */
  OPT_cpp = 964,                             /* -cpp */
  OPT_cpp_ = 965,                            /* -cpp= */
  OPT_d = 966,                               /* -d */
  OPT_debuglib_ = 967,                       /* -debuglib= */
  OPT_defaultlib_ = 968,                     /* -defaultlib= */
  OPT_defined_only = 969,                    /* -defined-only */
  OPT_demangle = 970,                        /* -demangle */
  OPT_dialect = 971,                         /* -dialect */
  OPT_dstartfiles = 972,                     /* -dstartfiles */
  OPT_dump_body_ = 973,                      /* -dump-body= */
  OPT_dump_level_ = 974,                     /* -dump-level= */
  OPT_dumpbase = 975,                        /* -dumpbase */
  OPT_dumpbase_ext = 976,                    /* -dumpbase-ext */
  OPT_dumpdir = 977,                         /* -dumpdir */
  OPT_dumpfullversion = 978,                 /* -dumpfullversion */
  OPT_dumpmachine = 979,                     /* -dumpmachine */
  OPT_dumpspecs = 980,                       /* -dumpspecs */
  OPT_dumpversion = 981,                     /* -dumpversion */
  OPT_e = 982,                               /* -e */
  OPT_export_dynamic = 983,                  /* -export-dynamic */
  OPT_fPIC = 984,                            /* -fPIC */
  OPT_fPIE = 985,                            /* -fPIE */
  OPT_fRTS_ = 986,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 987,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 988,                   /* -fabi-version= */
  OPT_faccess_control = 989,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 990,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 991,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 992,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 993,                  /* -falign-commons */
  OPT_falign_functions = 994,                /* -falign-functions */
  OPT_falign_functions_ = 995,               /* -falign-functions= */
  OPT_falign_jumps = 996,                    /* -falign-jumps */
  OPT_falign_jumps_ = 997,                   /* -falign-jumps= */
  OPT_falign_labels = 998,                   /* -falign-labels */
  OPT_falign_labels_ = 999,                  /* -falign-labels= */
  OPT_falign_loops = 1000,                   /* -falign-loops */
  OPT_falign_loops_ = 1001,                  /* -falign-loops= */
  /* OPT_faligned_new = 1002, */             /* -faligned-new */
  OPT_faligned_new_ = 1003,                  /* -faligned-new= */
  OPT_fall_instantiations = 1004,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1005,                /* -fall-intrinsics */
  OPT_fall_virtual = 1006,                   /* -fall-virtual */
  OPT_fallocation_dce = 1007,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1008,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1009,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1010,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1011, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1012,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1013,        /* -falt-external-templates */
  OPT_fanalyzer = 1014,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1015,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1016,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1017,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1018,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1019,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1020, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1021,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1022,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1023,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1024,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1025,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1026,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1027,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1028,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1029,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1030, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1031, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1032, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1033, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1034,           /* -fasan-shadow-offset= */
  OPT_fasm = 1035,                           /* -fasm */
  OPT_fassert = 1036,                        /* -fassert */
  OPT_fassociative_math = 1037,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1038,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1039,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1040,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1041,                     /* -fauto-init */
  OPT_fauto_profile = 1042,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1043,                 /* -fauto-profile= */
  OPT_fautomatic = 1044,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1045,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1046,                     /* -fbackslash */
  OPT_fbacktrace = 1047,                     /* -fbacktrace */
  OPT_fbit_tests = 1048,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1049,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1050,                        /* -fbounds */
  OPT_fbounds_check = 1051,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1052,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1053,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1054,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1055, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1056, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1057, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1058,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1059,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1060,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1061,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1062,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1063,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1064,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1065,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1066,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1067,                    /* -fcall-used- */
  OPT_fcaller_saves = 1068,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1069,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1070,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1071,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1072,      /* -fcanonical-system-headers */
  OPT_fcase = 1073,                          /* -fcase */
  /* OPT_fcf_protection = 1074, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1075,                /* -fcf-protection= */
  OPT_fchar8_t = 1076,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1077,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1078, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1079,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1080,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1081,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1082, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1083, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1084, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1085, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1086, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1087, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1088,                  /* -fcheckaction= */
  OPT_fchecking = 1089,                      /* -fchecking */
  OPT_fchecking_ = 1090,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1091,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1092,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1093,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1094,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1095,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1096,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1097,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1098,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1099,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1100,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1101,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1102,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1103,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1104,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1105,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1106,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1107,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1108,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1109, */                /* -fcilkplus */
  OPT_fcoarray_ = 1110,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1111,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1112,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1113,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1114,                        /* -fcommon */
  OPT_fcompare_debug = 1115,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1116,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1117,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1118,                  /* -fcompare-elim */
  OPT_fconcepts = 1119,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1120,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1121,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1122,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1123,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1124, */          /* -fconserve-space */
  OPT_fconserve_stack = 1125,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1126,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1127,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1128,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1129,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1130,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1131,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1132,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1133,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1134,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1135,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1136,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1137,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1138, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1139,                     /* -fcontracts */
  OPT_fconvert_ = 1140,                      /* -fconvert= */
  OPT_fcoroutines = 1141,                    /* -fcoroutines */
  OPT_fcpp = 1142,                           /* -fcpp */
  OPT_fcpp_begin = 1143,                     /* -fcpp-begin */
  OPT_fcpp_end = 1144,                       /* -fcpp-end */
  OPT_fcprop_registers = 1145,               /* -fcprop-registers */
  OPT_fcray_pointer = 1146,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1147,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1148,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1149, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1150,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1151,              /* -fcx-limited-range */
  OPT_fd = 1152,                             /* -fd */
  OPT_fd_lines_as_code = 1153,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1154,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1155,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1156,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1157,                      /* -fdbg-cnt= */
  OPT_fdce = 1158,                           /* -fdce */
  OPT_fdebug = 1159,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1160,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1161,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1162,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1163,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1164,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1165,           /* -fdebug-types-section */
  OPT_fdebug_ = 1166,                        /* -fdebug= */
  OPT_fdec = 1167,                           /* -fdec */
  OPT_fdec_blank_format_item = 1168,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1169,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1170,           /* -fdec-format-defaults */
  OPT_fdec_include = 1171,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1172,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1173,                      /* -fdec-math */
  OPT_fdec_static = 1174,                    /* -fdec-static */
  OPT_fdec_structure = 1175,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1176,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1177, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1178,                          /* -fdef= */
  OPT_fdefault_double_8 = 1179,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1180, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1181,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1182,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1183,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1184,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1185,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1186,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1187,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1188,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1189,    /* -fdelete-null-pointer-checks */
  OPT_fdeps_file_ = 1190,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1191,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1192,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1193,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1194,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1195,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1196,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1197,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1198, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1199,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1200,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1201,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1202,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1203,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1204,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1205,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1206,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1207,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1208,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1209,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1210,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1211,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1212,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1213,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1214,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1215,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1216, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1217,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1218,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1219,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1220,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1221,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1222, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1223,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1224,               /* -fdirectives-only */
  OPT_fdisable_ = 1225,                      /* -fdisable- */
  OPT_fdoc = 1226,                           /* -fdoc */
  OPT_fdoc_dir_ = 1227,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1228,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1229,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1230,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1231,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1232,                      /* -fdruntime */
  OPT_fdse = 1233,                           /* -fdse */
  OPT_fdump_ = 1234,                         /* -fdump- */
  OPT_fdump_ada_spec = 1235,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1236,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1237,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1238,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1239,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1240,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1241,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1242,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1243,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1244,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1245,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1246,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1247,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1248,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1249,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1250,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1251,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1252,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1253, */               /* -fdump-core */
  OPT_fdump_d_original = 1254,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1255,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1256,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1257,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1258,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1259,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1260,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1261,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1262,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1263, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1264,                   /* -fdump-passes */
  OPT_fdump_scos = 1265,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1266,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1267,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1268,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1269,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1270,                /* -fearly-inlining */
  OPT_felide_constructors = 1271,            /* -felide-constructors */
  OPT_felide_type = 1272,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1273, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1274,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1275,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1276,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1277,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1278,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1279,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1280,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1281,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1282,                /* -fenum-int-equiv */
  OPT_fexceptions = 1283,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1284,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1285,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1286,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1287,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1288,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1289,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1290,               /* -fextended-opaque */
  OPT_fextern_std_ = 1291,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1292,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1293,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1294,            /* -fexternal-templates */
  OPT_ff2c = 1295,                           /* -ff2c */
  OPT_ffast_math = 1296,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1297,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1298,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1299,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1300,              /* -ffinite-math-only */
  OPT_ffixed_ = 1301,                        /* -ffixed- */
  OPT_ffixed_form = 1302,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1303,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1304,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1305,                    /* -fflex-debug */
  OPT_ffloat_store = 1306,                   /* -ffloat-store */
  OPT_ffloatvalue = 1307,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1308,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1309,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1310,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1311, */              /* -fforce-addr */
  OPT_fforward_propagate = 1312,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1313,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1314,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1315,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1316,                     /* -ffpe-trap= */
  OPT_ffree_form = 1317,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1318,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1319,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1320,                  /* -ffreestanding */
  OPT_ffriend_injection = 1321,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1322,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1323,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1324,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1325,             /* -ffunction-sections */
  OPT_fgcse = 1326,                          /* -fgcse */
  OPT_fgcse_after_reload = 1327,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1328,                      /* -fgcse-las */
  OPT_fgcse_lm = 1329,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1330,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1331,              /* -fgen-module-list= */
  OPT_fgimple = 1332,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1333,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1334,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1335,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1336,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1337,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1338,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1339,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1340,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1341,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1342,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1343,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1344,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1345,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1346,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1347,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1348,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1349,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1350,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1351,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1352,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1353,                      /* -fgraphite */
  OPT_fgraphite_identity = 1354,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1355,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1356,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1357, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1358,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1359, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1360, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1361,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1362,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1363,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1364,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1365,                      /* -fhardened */
  /* OPT_fhelp = 1366, */                    /* -fhelp */
  /* OPT_fhelp_ = 1367, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1368,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1369,                     /* -fhonor-std */
  OPT_fhosted = 1370,                        /* -fhosted */
  OPT_fhuge_objects = 1371,                  /* -fhuge-objects */
  OPT_fident = 1372,                         /* -fident */
  OPT_fif_conversion = 1373,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1374,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1375,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1376,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1377,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1378,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1379,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1380,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1381,            /* -fimplicit-templates */
  OPT_finclude_imports = 1382,               /* -finclude-imports */
  OPT_findex = 1383,                         /* -findex */
  OPT_findicator_column = 1384,              /* -findicator-column */
  OPT_findirect_inlining = 1385,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1386,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1387,               /* -finit-character= */
  OPT_finit_derived = 1388,                  /* -finit-derived */
  OPT_finit_integer_ = 1389,                 /* -finit-integer= */
  OPT_finit_local_zero = 1390,               /* -finit-local-zero */
  OPT_finit_logical_ = 1391,                 /* -finit-logical= */
  OPT_finit_real_ = 1392,                    /* -finit-real= */
  OPT_finline = 1393,                        /* -finline */
  OPT_finline_arg_packing = 1394,            /* -finline-arg-packing */
  OPT_finline_atomics = 1395,                /* -finline-atomics */
  OPT_finline_functions = 1396,              /* -finline-functions */
  OPT_finline_functions_called_once = 1397,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1398,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1399,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1400, */           /* -finline-limit- */
  OPT_finline_limit_ = 1401,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1402,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1403,        /* -finline-small-functions */
  OPT_finline_stringops = 1404,              /* -finline-stringops */
  OPT_finline_stringops_ = 1405,             /* -finline-stringops= */
  OPT_finput_charset_ = 1406,                /* -finput-charset= */
  OPT_finstrument_functions = 1407,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1408,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1409,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1410,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1411,           /* -finteger-4-integer-8 */
  OPT_finternal_ebcdic = 1412,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1413,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1414,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1415,                    /* -finvariants */
  OPT_fipa_bit_cp = 1416,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1417,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1418, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1419,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1420,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1421,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1422,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1423, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1424,                    /* -fipa-modref */
  OPT_fipa_profile = 1425,                   /* -fipa-profile */
  OPT_fipa_pta = 1426,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1427,                /* -fipa-pure-const */
  OPT_fipa_ra = 1428,                        /* -fipa-ra */
  OPT_fipa_reference = 1429,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1430,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1431,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1432,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1433,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1434,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1435, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1436,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1437,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1438,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1439,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1440,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1441,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1442,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1443,                  /* -fira-verbose= */
  OPT_fiso = 1444,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1445,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1446,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1447,              /* -fivar-visibility= */
  OPT_fivopts = 1448,                        /* -fivopts */
  OPT_fjump_tables = 1449,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1450,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1451,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1452,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1453,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1454,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1455,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1456,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1457,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1458,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1459,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1460,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1461, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1462,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1463,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1464,            /* -fleading-underscore */
  OPT_flibs_ = 1465,                         /* -flibs= */
  OPT_flifetime_dse = 1466,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1467,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1468,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1469,                /* -flinker-output= */
  /* OPT_flive_patching = 1470, */           /* -flive-patching */
  OPT_flive_patching_ = 1471,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1472,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1473,                   /* -flocal-ivars */
  OPT_flocation_ = 1474,                     /* -flocation= */
  /* OPT_floop_block = 1475, */              /* -floop-block */
  /* OPT_floop_flatten = 1476, */            /* -floop-flatten */
  OPT_floop_interchange = 1477,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1478,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1479, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1480,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1481, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1482,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1483,                     /* -flra-remat */
  OPT_flto = 1484,                           /* -flto */
  OPT_flto_compression_level_ = 1485,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1486,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1487,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1488, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1489,                /* -flto-partition= */
  OPT_flto_report = 1490,                    /* -flto-report */
  OPT_flto_report_wpa = 1491,                /* -flto-report-wpa */
  OPT_flto_ = 1492,                          /* -flto= */
  OPT_fltrans = 1493,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1494,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1495,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1496,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1497,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1498,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1499,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1500,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1501,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1502,                          /* -fm2-g */
  OPT_fm2_lower_case = 1503,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1504,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1505,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1506,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1507,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1508,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1509,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1510,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1511,             /* -fmacro-prefix-map= */
  OPT_fmain = 1512,                          /* -fmain */
  OPT_fmalloc_dce = 1513,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1514,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1515,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1516,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1517,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1518,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1519,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1520,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1521,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1522,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1523,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1524,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1525,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1526,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1527,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1528,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1529,                          /* -fmod= */
  OPT_fmodule_file_ = 1530,                  /* -fmodule-file= */
  OPT_fmodule_header = 1531,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1532,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1533,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1534,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1535,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1536,                   /* -fmodule-only */
  OPT_fmodule_private = 1537,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1538,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1539,                    /* -fmoduleinfo */
  OPT_fmodules = 1540,                       /* -fmodules */
  /* OPT_fmodules_ts = 1541, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1542,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1543,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1544,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1545,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1546,                 /* -fms-extensions */
  OPT_fmudflap = 1547,                       /* -fmudflap */
  OPT_fmudflapir = 1548,                     /* -fmudflapir */
  OPT_fmudflapth = 1549,                     /* -fmudflapth */
  OPT_fmultiflags = 1550,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1551,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1552,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1553,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1554,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1555,                  /* -fnext-runtime */
  OPT_fnil = 1556,                           /* -fnil */
  OPT_fnil_receivers = 1557,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1558,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1559,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1560,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1561,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1562,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1563,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1564,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1565,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1566,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1567,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1568,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1569,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1570,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1571,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1572,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1573,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1574,              /* -foffload-options= */
  OPT_foffload_ = 1575,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1576,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1577,                         /* -fonly= */
  OPT_fopenacc = 1578,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1579,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1580,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1581,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1582,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1583, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1584,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1585,                /* -foperator-names */
  OPT_fopt_info = 1586,                      /* -fopt-info */
  OPT_fopt_info_ = 1587,                     /* -fopt-info- */
  OPT_foptimize_crc = 1588,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1589, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1590,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1591,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1592, */          /* -foptional-diags */
  OPT_fpack_derived = 1593,                  /* -fpack-derived */
  OPT_fpack_struct = 1594,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1595,                  /* -fpack-struct= */
  OPT_fpad_source = 1596,                    /* -fpad-source */
  OPT_fpartial_inlining = 1597,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1598,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1599,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1600,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1601,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1602,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1603,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1604,                    /* -fpeel-loops */
  OPT_fpeephole = 1605,                      /* -fpeephole */
  OPT_fpeephole2 = 1606,                     /* -fpeephole2 */
  OPT_fpermissive = 1607,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1608,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1609,                           /* -fpic */
  OPT_fpie = 1610,                           /* -fpie */
  OPT_fpim = 1611,                           /* -fpim */
  OPT_fpim2 = 1612,                          /* -fpim2 */
  OPT_fpim3 = 1613,                          /* -fpim3 */
  OPT_fpim4 = 1614,                          /* -fpim4 */
  OPT_fplan9_extensions = 1615,              /* -fplan9-extensions */
  OPT_fplt = 1616,                           /* -fplt */
  OPT_fplugin_arg_ = 1617,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1618,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1619,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1620,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1621,                /* -fpostconditions */
  OPT_fpre_include_ = 1622,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1623,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1624,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1625,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1626,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1627,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1628,              /* -fpretty-templates */
  OPT_fpreview_all = 1629,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1630,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1631,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1632,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1633,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1634,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1635,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1636,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1637,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1638,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1639,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1640,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1641,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1642,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1643,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1644,           /* -fprintf-return-value */
  OPT_fprofile = 1645,                       /* -fprofile */
  OPT_fprofile_abs_path = 1646,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1647,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1648,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1649,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1650,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1651,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1652,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1653,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1654,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1655,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1656,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1657,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1658,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1659,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1660,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1661,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1662,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1663,               /* -fprofile-update= */
  OPT_fprofile_use = 1664,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1665,                  /* -fprofile-use= */
  OPT_fprofile_values = 1666,                /* -fprofile-values */
  OPT_fprotect_parens = 1667,                /* -fprotect-parens */
  OPT_fpthread = 1668,                       /* -fpthread */
  OPT_fq = 1669,                             /* -fq */
  OPT_frandom_seed = 1670,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1671,                  /* -frandom-seed= */
  OPT_frange = 1672,                         /* -frange */
  OPT_frange_check = 1673,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1674,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1675,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1676,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1677,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1678,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1679,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1680,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1681,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1682,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1683,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1684,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1685,               /* -frecord-marker=8 */
  OPT_frecursive = 1686,                     /* -frecursive */
  OPT_free = 1687,                           /* -free */
  /* OPT_freg_struct_return = 1688, */       /* -freg-struct-return */
  /* OPT_fregmove = 1689, */                 /* -fregmove */
  OPT_frelease = 1690,                       /* -frelease */
  OPT_frename_registers = 1691,              /* -frename-registers */
  OPT_freorder_blocks = 1692,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1693,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1694,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1695,             /* -freorder-functions */
  OPT_frepack_arrays = 1696,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1697,          /* -freplace-objc-classes */
  OPT_frepo = 1698,                          /* -frepo */
  OPT_freport_bug = 1699,                    /* -freport-bug */
  OPT_frequire_return_statement = 1700,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1701,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1702, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1703,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1704,                   /* -fresolution= */
  OPT_freturn = 1705,                        /* -freturn */
  OPT_frevert_all = 1706,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1707,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1708,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1709,             /* -frevert=intpromote */
  OPT_frounding_math = 1710,                 /* -frounding-math */
  OPT_frtti = 1711,                          /* -frtti */
  OPT_fruntime_modules_ = 1712,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1713,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1714,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1715,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1716,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1717,                   /* -frust-crate= */
  OPT_frust_debug = 1718,                    /* -frust-debug */
  OPT_frust_dump_ = 1719,                    /* -frust-dump- */
  OPT_frust_edition_ = 1720,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1721,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1722,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1723,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1724,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1725,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1726,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1727,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1728,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1729,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1730,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1731,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1732,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1733,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1734,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1735,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1736,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1737, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1738,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1739,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1740,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1741,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1742,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1743,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1744,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1745,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1746, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1747,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1748,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1749,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1750,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1751,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1752,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1753,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1754,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1755,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1756,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1757,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1758,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1759,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1760,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1761,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1762,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1763, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1764,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1765,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1766,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1767,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1768,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1769,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1770,               /* -fsection-anchors */
  /* OPT_fsee = 1771, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1772,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1773,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1774,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1775,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1776,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1777,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1778,        /* -fsemantic-interposition */
  ...
  OPT_list = 2042,                           /* -list */
  OPT_mabi_ = 2043,                          /* -mabi= */
  OPT_madjust_lmul_cost = 2044,              /* -madjust-lmul-cost */
  OPT_main = 2045,                           /* -main */
  OPT_main_ = 2046,                          /* -main= */
  OPT_malign_data_ = 2047,                   /* -malign-data= */
  OPT_march_ = 2048,                         /* -march= */
  OPT_march_help = 2049,                     /* -march=help */
  OPT_mautovec_segment = 2050,               /* -mautovec-segment */
  OPT_mbig_endian = 2051,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 2052,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 2053,                       /* -mcmodel= */
  OPT_mcpu_ = 2054,                          /* -mcpu= */
  OPT_mcsr_check = 2055,                     /* -mcsr-check */
  OPT_mdiv = 2056,                           /* -mdiv */
  OPT_mexplicit_relocs = 2057,               /* -mexplicit-relocs */
  OPT_mfdiv = 2058,                          /* -mfdiv */
  OPT_mfence_tso = 2059,                     /* -mfence-tso */
  OPT_minline_atomics = 2060,                /* -minline-atomics */
  OPT_minline_strcmp = 2061,                 /* -minline-strcmp */
  OPT_minline_strlen = 2062,                 /* -minline-strlen */
  OPT_minline_strncmp = 2063,                /* -minline-strncmp */
  OPT_misa_spec_ = 2064,                     /* -misa-spec= */
  OPT_mlittle_endian = 2065,                 /* -mlittle-endian */
  OPT_mmovcc = 2066,                         /* -mmovcc */
  OPT_momit_leaf_frame_pointer = 2067,       /* -momit-leaf-frame-pointer */
  /* OPT_mplt = 2068, */                     /* -mplt */
  OPT_mpreferred_stack_boundary_ = 2069,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 2070,                         /* -mrelax */
  OPT_mriscv_attribute = 2071,               /* -mriscv-attribute */
  OPT_mrvv_max_lmul_ = 2072,                 /* -mrvv-max-lmul= */
  OPT_mrvv_vector_bits_ = 2073,              /* -mrvv-vector-bits= */
  OPT_msave_restore = 2074,                  /* -msave-restore */
  /* OPT_mscalar_strict_align = 2075, */     /* -mscalar-strict-align */
  OPT_mshorten_memrefs = 2076,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 2077,             /* -msmall-data-limit= */
  OPT_mstack_protector_guard_offset_ = 2078, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2079,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2080,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2081,                  /* -mstrict-align */
  OPT_mstringop_strategy_ = 2082,            /* -mstringop-strategy= */
  OPT_mtls_dialect_ = 2083,                  /* -mtls-dialect= */
  OPT_mtune_ = 2084,                         /* -mtune= */
  OPT_mvector_strict_align = 2085,           /* -mvector-strict-align */
  OPT_n = 2086,                              /* -n */
  OPT_name_sort = 2087,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2088,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2089,              /* -no-integrated-cpp */
  OPT_no_pie = 2090,                         /* -no-pie */
  OPT_nocpp = 2091,                          /* -nocpp */
  OPT_nodefaultlibs = 2092,                  /* -nodefaultlibs */
  OPT_nolibc = 2093,                         /* -nolibc */
  OPT_nomain = 2094,                         /* -nomain */
  OPT_nophoboslib = 2095,                    /* -nophoboslib */
  OPT_nostartfiles = 2096,                   /* -nostartfiles */
  OPT_nostdinc = 2097,                       /* -nostdinc */
  OPT_nostdinc__ = 2098,                     /* -nostdinc++ */
  OPT_nostdlib = 2099,                       /* -nostdlib */
  OPT_nostdlib__ = 2100,                     /* -nostdlib++ */
  OPT_o = 2101,                              /* -o */
  OPT_objects = 2102,                        /* -objects */
  OPT_p = 2103,                              /* -p */
  OPT_pass_exit_codes = 2104,                /* -pass-exit-codes */
  /* OPT_pedantic = 2105, */                 /* -pedantic */
  OPT_pedantic_errors = 2106,                /* -pedantic-errors */
  OPT_pg = 2107,                             /* -pg */
  OPT_pie = 2108,                            /* -pie */
  OPT_pipe = 2109,                           /* -pipe */
  OPT_preprocess = 2110,                     /* -preprocess */
  OPT_print_file_name_ = 2111,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2112,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2113,          /* -print-multi-directory */
  OPT_print_multi_lib = 2114,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2115,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2116,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2117,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2118,               /* -print-prog-name= */
  OPT_print_search_dirs = 2119,              /* -print-search-dirs */
  /* OPT_print_supported_extensions = 2120, *//* -print-supported-extensions */
  OPT_print_sysroot = 2121,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2122,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2123,                    /* -print-value */
  OPT_quiet = 2124,                          /* -quiet */
  OPT_r = 2125,                              /* -r */
  OPT_remap = 2126,                          /* -remap */
  OPT_reverse_sort = 2127,                   /* -reverse-sort */
  OPT_s = 2128,                              /* -s */
  OPT_save_temps = 2129,                     /* -save-temps */
  OPT_save_temps_ = 2130,                    /* -save-temps= */
  OPT_shared = 2131,                         /* -shared */
  OPT_shared_libgcc = 2132,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2133,               /* -shared-libphobos */
  OPT_size_sort = 2134,                      /* -size-sort */
  /* OPT_specs = 2135, */                    /* -specs */
  OPT_specs_ = 2136,                         /* -specs= */
  OPT_static = 2137,                         /* -static */
  OPT_static_libasan = 2138,                 /* -static-libasan */
  OPT_static_libgcc = 2139,                  /* -static-libgcc */
  OPT_static_libgcobol = 2140,               /* -static-libgcobol */
  OPT_static_libgfortran = 2141,             /* -static-libgfortran */
  OPT_static_libgm2 = 2142,                  /* -static-libgm2 */
  OPT_static_libgo = 2143,                   /* -static-libgo */
  OPT_static_libhwasan = 2144,               /* -static-libhwasan */
  OPT_static_liblsan = 2145,                 /* -static-liblsan */
  OPT_static_libmpx = 2146,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2147,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2148,               /* -static-libphobos */
  OPT_static_libquadmath = 2149,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2150,               /* -static-libstdc++ */
  OPT_static_libtsan = 2151,                 /* -static-libtsan */
  OPT_static_libubsan = 2152,                /* -static-libubsan */
  OPT_static_pie = 2153,                     /* -static-pie */
  /* OPT_std_c__03 = 2154, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2155, */                /* -std=c++0x */
  OPT_std_c__11 = 2156,                      /* -std=c++11 */
  OPT_std_c__14 = 2157,                      /* -std=c++14 */
  OPT_std_c__17 = 2158,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2159, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2160, */                /* -std=c++1z */
  OPT_std_c__20 = 2161,                      /* -std=c++20 */
  OPT_std_c__23 = 2162,                      /* -std=c++23 */
  OPT_std_c__26 = 2163,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2164, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2165, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2166, */                /* -std=c++2c */
  OPT_std_c__98 = 2167,                      /* -std=c++98 */
  OPT_std_c11 = 2168,                        /* -std=c11 */
  OPT_std_c17 = 2169,                        /* -std=c17 */
  /* OPT_std_c18 = 2170, */                  /* -std=c18 */
  /* OPT_std_c1x = 2171, */                  /* -std=c1x */
  OPT_std_c23 = 2172,                        /* -std=c23 */
  /* OPT_std_c2x = 2173, */                  /* -std=c2x */
  OPT_std_c2y = 2174,                        /* -std=c2y */
  /* OPT_std_c89 = 2175, */                  /* -std=c89 */
  OPT_std_c90 = 2176,                        /* -std=c90 */
  OPT_std_c99 = 2177,                        /* -std=c99 */
  /* OPT_std_c9x = 2178, */                  /* -std=c9x */
  OPT_std_f2003 = 2179,                      /* -std=f2003 */
  OPT_std_f2008 = 2180,                      /* -std=f2008 */
  OPT_std_f2008ts = 2181,                    /* -std=f2008ts */
  OPT_std_f2018 = 2182,                      /* -std=f2018 */
  OPT_std_f2023 = 2183,                      /* -std=f2023 */
  OPT_std_f202y = 2184,                      /* -std=f202y */
  OPT_std_f95 = 2185,                        /* -std=f95 */
  OPT_std_gnu = 2186,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2187, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2188, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2189,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2190,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2191,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2192, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2193, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2194,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2195,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2196,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2197, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2198, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2199, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2200,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2201,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2202,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2203, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2204, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2205,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2206, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2207,                      /* -std=gnu2y */
  ...
  /* OPT_std_iso9899_2024 = 2219, */         /* -std=iso9899:2024 */
  ...
  OPT_truncate = 2231,                       /* -truncate */
  OPT_type_stats = 2232,                     /* -type-stats */
  OPT_u = 2233,                              /* -u */
  OPT_undef = 2234,                          /* -undef */
  OPT_v = 2235,                              /* -v */
  OPT_version = 2236,                        /* -version */
  OPT_w = 2237,                              /* -w */
  OPT_wrapper = 2238,                        /* -wrapper */
  OPT_x = 2239,                              /* -x */
  OPT_z = 2240,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
