...
OUTPUT_ARCH(riscv)
ENTRY(_start)
SEARCH_DIR("=/home/ilg/actions-runners/xpack-dev-tools/1/_work/riscv-none-elf-gcc-xpack/riscv-none-elf-gcc-xpack/build-assets/build/linux-x64/application/riscv-none-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
